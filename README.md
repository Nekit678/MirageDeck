...
5. Сенсорный экран запускается в Knob Mode: четыре области соответствуют четырём
   энкодерам, горизонтальный свайп переключает страницу/сцену. Свайп вверх
   включает Touchbar Mode с координатными касаниями, свайп вниз возвращает Knob
   Mode. Как и на физическом N4 Pro, значки энкодеров в Touchbar Mode скрыты.

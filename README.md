...
5. В Button Mode четыре области сенсорного экрана соответствуют четырём
   энкодерам, горизонтальный свайп переключает страницу/сцену. Свайп вверх
   включает Touchbar Mode с координатными касаниями, свайп вниз возвращает
   Button Mode. Переключатель режима в редакторе Stream Dock выбирает область
   настройки, но не переключает экран устройства. Как и на физическом N4 Pro,
   значки энкодеров в Touchbar Mode скрыты.

...
5. В Button Mode четыре области сенсорного экрана соответствуют четырём
   ...
   Button Mode. В Touchbar Mode короткий тап запускает элемент, а горизонтальный
   жест прокручивает набор или переключает страницу согласно настройкам профиля.

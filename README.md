...
обычное HID-устройство с идентификаторами `VID_5548&PID_1008`, а отдельная
...
1. Убедитесь, что панель показывает `Подключено: HID 5548:1008`.
...
- Это профиль **N4 Pro 5548:1008**. Другие модели Mirabox имеют другие VID/PID,
